...
import com.example.ebooks.adapters.CartAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkoutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cartList.isEmpty()) {
                    Toasty.warning(CartActivity.this, "Your cart is empty!", Toasty.LENGTH_SHORT).show();
                } else {
                    ...
                    for (Cart item : cartList) {
                        ...
                        cartOrderMap.setBookId(item.getBookId());
